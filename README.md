...
[Long Short Pairs Trading](LongShortPairsTrading.ipynb) - A demonstration of a long short pairs strategy with different holding
periods between Coca Cola (KO) and Pepsico (PEP)

[Long Only Pairs Trading](LongOnlyPairsTrading.ipynb) - An illustrative example of a long only pairs trading strategy focused on minimizing weighted median drawdown
...
[Geographical Diversification](GeographicDiversification.ipynb) - An illustrative example on the effects of international diversification, with an optimization example on how to obtain an optimally risk adjusted portfolio (maximizing sharpe) between several market indexes
